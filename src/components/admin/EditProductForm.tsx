      ...
      <div className="w-full overflow-hidden">
        ...
        <div className="flex gap-2 mb-1 w-full">
          <input
            ...
            className="flex-1 min-w-0 bg-neutral-800 border border-neutral-700 text-white rounded-lg px-4 py-2.5 focus:outline-none focus:ring-red-600 transition-colors"
          />
          <button
            type="button"
